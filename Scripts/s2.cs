...
public class s2 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            Debug.LogError($"s2 on '{gameObject.name}': Parent 'playerscript' not found. This script requires a 'playerscript' on its parent.");
        ...
        // if (col == null)
        // {
        //     Debug.LogError($"s2 on '{gameObject.name}': No Collider found. Please add a Collider component.");
        //     enabled = false;
        //     return;
        // }
        // if (!col.isTrigger)
        // {
        //     Debug.LogWarning($"s2 on '{gameObject.name}': Collider is not set to 'Is Trigger'. Setting it now.");
        //     col.isTrigger = true;
        // }
        ...
        // if (rb == null)
        // {
        //     Debug.LogError($"s2 on '{gameObject.name}': No Rigidbody found. Please add a Rigidbody component.");
        //     enabled = false;
        //     return;
        // }
    ...
    void OnTriggerEnter(Collider other)
    {
            ...
            string udpMessage = "2.0," + parentVelVal.ToString("F1");
            ...
            Debug.Log($"2 collided with trigger '{other.gameObject.name}'");
    ...
    void OnTriggerExit(Collider other)
    {
            ...
            Debug.Log($"2 exited trigger '{other.gameObject.name}'.");
