...
public class s6 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            Debug.LogError($"s6 on '{gameObject.name}': Parent 'playerscript' not found. This script requires a 'playerscript' on its parent.");
        ...
        // if (col == null)
        // {
        //     Debug.LogError($"s6 on '{gameObject.name}': No Collider found. Please add a Collider component.");
        //     enabled = false;
        //     return;
        // }
        // if (!col.isTrigger)
        // {
        //     Debug.LogWarning($"s6 on '{gameObject.name}': Collider is not set to 'Is Trigger'. Setting it now.");
        //     col.isTrigger = true;
        // }
        ...
        // if (rb == null)
        // {
        //     Debug.LogError($"s6 on '{gameObject.name}': No Rigidbody found. Please add a Rigidbody component.");
        //     enabled = false;
        //     return;
        // }
    ...
    void OnTriggerEnter(Collider other)
    {
            ...
            string udpMessage = "6.0," + parentVelVal.ToString("F1");
            ...
            Debug.Log($"6 collided with trigger '{other.gameObject.name}'");

            // Logging the collision
            //arentPlayerScript.LogChildCollision(this.gameObject, other.gameObject, other.gameObject.transform.position);
    ...
    void OnTriggerExit(Collider other)
    {
            ...
            Debug.Log($"6 exited trigger '{other.gameObject.name}'. ");
